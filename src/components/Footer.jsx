    ...
    <footer className="bg-black text-white pt-12 pb-8 font-sans border-t border-zinc-900 select-none">
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20 grid gap-10 grid-cols-1 md:grid-cols-[1.2fr_2.2fr_2.2fr] items-start text-[14px]">
        ...
        <div className="flex flex-col md:items-end justify-between h-full md:text-right">
          ...
          <div className="flex items-center gap-5 mt-8 md:mt-auto md:justify-end">
            {/* Facebook */}
            <a href="#" className="text-zinc-400 hover:text-[#ff9933] transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.8z" />
              </svg>
            </a>
            {/* Instagram */}
            <a href="#" className="text-zinc-400 hover:text-[#ff9933] transition-colors" aria-label="Instagram">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            {/* Linkedin */}
            <a href="#" className="text-zinc-400 hover:text-[#ff9933] transition-colors" aria-label="LinkedIn">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-20 mt-6 flex flex-col items-center justify-center text-[13px] text-zinc-400 gap-2">
        ...
        <div className="flex items-center gap-4 mt-1">
          <button type="button" className="hover:text-white transition-colors bg-transparent border-none p-0 cursor-pointer">
            Privacy Policy
          </button>
